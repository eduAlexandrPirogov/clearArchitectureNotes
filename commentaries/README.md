...
И вот тут стоит обратить на важный момент: мы говорим не "что" делает класс, а "зачем" он нужен системе. В чем разница? Например, АСД словарь и список, если описывать их со стороны "что делают", то быстро придет к выводу, что добавляют/удаляют/ищут/изменяют хранящиеся данные. Но если мы будет задавать вопрос "зачем?", то быстро поймем мотивацию использования того или иного класса.

По итогу, для вышеприведенных классов, будут лучше следующие комментарии?
